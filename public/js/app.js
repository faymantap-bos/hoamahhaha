...
async function deleteSelectedEmail() {
  ...
  const confirmed = await window.nebulaConfirm({
    eyebrow: "NOXXY Warning",
    title: "Hapus email ini?",
    message: "Email dan lampiran akan dihapus permanen. Tindakan ini tidak dapat dibatalkan.",
    confirmText: "Hapus email",
    cancelText: "Batal"
  });
  if (!confirmed) return;
